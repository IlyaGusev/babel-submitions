...
python3 train.py -src_lang en -tgt_lang ru -train_src_mono ../data/corpus.tok.clean.tc.en \
    ...
    -print_every 100 -batch_size 64 -src_embeddings ../models/wiki.multi.en.vec -tgt_embeddings ../models/wiki.multi.ru.vec \
    -discriminator_hidden_size 512 -supervised-only True